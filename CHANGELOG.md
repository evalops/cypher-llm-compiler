...
- Added `cypher-llm-agent-workspace/v1` packets that combine LSP diagnostics, editor quick fixes, proof, repair plan, policy evidence, next action, and model instructions for IDE/chat repair loops.
