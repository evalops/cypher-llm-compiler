...
describe("json schemas", () => {
  it("validate the checked-in examples used by the CLI and eval runner", () => {
    ...
    assertValid(ajv, "https://evalops.dev/schemas/cypher-llm/agent-workspace/v1.json", readJson("examples/agent/tool-hash.workspace.json"));
    ...
    assertValid(ajv, "https://evalops.dev/schemas/cypher-llm/service-openapi/v1.json", readJson("examples/service/service-openapi.json"));
